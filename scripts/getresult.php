...
<form id="frmSearch<?echo$thistable;?>" name="frmSearch<?echo$thistable;?>" method="post" action="index.php">
			...
			<input type="button" name="go" class="btnSearch" value="Search" onclick="getresult('<?php echo $paginationlink . $page; ?>&searchintable=<?echo$thistable;?>', '<?echo$thistable;?>')"><input type="reset" class="btnSearch" value="Reset" onclick="window.location='index.php'"></p>
			-->
...
$('<?echo"#frmSearch$thistable";?> .name').keyup(function(){
	getresult('<?php echo $paginationlink . $page; ?>&searchintable=<?echo$thistable;?>', '<?echo$thistable;?>', function(){$('<?echo"#frmSearch$thistable";?> .name').focus();
	//focus end of string
	var tmpStr = $('<?echo"#frmSearch$thistable";?> .name').val();
	$('<?echo"#frmSearch$thistable";?> .name').val('');
	$('<?echo"#frmSearch$thistable";?> .name').val(tmpStr);
	});
